...
processed-position count. The project stores that count, the total match count,
and the first 1,000 matches as decimal strings, so a reload can resume exactly
without losing integer precision in JSON.
